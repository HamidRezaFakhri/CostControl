namespace CostControl.BusinessEntity.Models.CostControl
{
	...
	public class IntakeRemittanceItemLog : BaseValidating, Base.Interfaces.IEntity<long>
	{
		...
		public override IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
		{
			...
			if (IntakeRemittanceItemId <= 0)
			{
				yield return new ValidationResult(ValidationMessages.CanNotBeEmpty(nameof(IntakeRemittanceItemId)), new[] { nameof(IntakeRemittanceItemId) });
			}
			#endregion
