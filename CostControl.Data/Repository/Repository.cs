namespace CostControl.Data.Repository
{
	...
	using CostControl.Data.Extentions;
		...
		//public class Repository<TEntity> where TEntity : class
	{
		...
		//https://stackoverflow.com/questions/31656938/how-to-convert-a-data-reader-to-dynamic-query-results
		public IEnumerable<dynamic> GetRawSql(string query)
		{
			using (var command = _unitOfWork.Context.Database.GetDbConnection().CreateCommand())
			{
				...
				return command.ExecuteReader().ConvertToList();
